            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
                        <a href="{{route('lecturer.dashboard')}}"  aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="student" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('lecturer.my_student')}}"> My Student </a>
                            </li>
                            <li>
                                <a href="{{route('lecturer.student')}}"> All Students </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="course" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('lecturer.my_course')}}"> My Course </a>
                            </li>
                            <li>
                                <a href="{{route('lecturer.course')}}"> All Course  </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="{{route('lecturer.event')}}"  class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{route('lecturer.exam_schedule')}}"  aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a  href="{{route('lecturer.profile')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a  href="{{route('lecturer.setting')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                                <span>Settings</span>
                            </div>
                    ...
                    <li class="menu">
                        <a href="{{route('lecturer.logout')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                                <span>Logout</span>
                            </div>
